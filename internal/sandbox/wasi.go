...
func (dir dirFS) PathOpen(ctx context.Context, lookupFlags wasi.LookupFlags, filePath string, openFlags wasi.OpenFlags, rightsBase, rightsInheriting wasi.Rights, fdFlags wasi.FDFlags) (wasiFile, wasi.Errno) {
...
func (f *dirFile) PathLink(ctx context.Context, flags wasi.LookupFlags, oldPath string, newDir wasiFile, newPath string) wasi.Errno {
	d, ok := newDir.(*dirFile)
	if !ok {
		return wasi.EXDEV
	}
...
func (f *dirFile) PathOpen(ctx context.Context, lookupFlags wasi.LookupFlags, path string, openFlags wasi.OpenFlags, rightsBase, rightsInheriting wasi.Rights, fdFlags wasi.FDFlags) (wasiFile, wasi.Errno) {
...
func (f *dirFile) PathRename(ctx context.Context, oldPath string, newDir wasiFile, newPath string) wasi.Errno {
	d, ok := newDir.(*dirFile)
	if !ok {
		return wasi.EXDEV
	}
