...
const (
	TaskState_TASK_STATE_UNSPECIFIED  TaskState = 0 // buf lint complains if this isn't here..
...
var file_timecraft_server_v1_timecraft_proto_rawDesc = []byte{
	...
	0x6b, 0x49, 0x64, 0x22, 0x4a, 0x0a, 0x12, 0x4c, 0x6f, 0x6f, 0x6b, 0x75, 0x70, 0x54, 0x61, 0x73,
	0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x34, 0x0a, 0x05, 0x73, 0x74, 0x61,
	0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e, 0x2e, 0x74, 0x69, 0x6d, 0x65, 0x63,
	0x72, 0x61, 0x66, 0x74, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x54,
	0x61, 0x73, 0x6b, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22,
...
var file_timecraft_server_v1_timecraft_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_timecraft_server_v1_timecraft_proto_goTypes = []interface{}{
	...
	(*Header)(nil),             // 3: timecraft.server.v1.Header
	(*SubmitTaskRequest)(nil),  // 4: timecraft.server.v1.SubmitTaskRequest
	(*SubmitTaskResponse)(nil), // 5: timecraft.server.v1.SubmitTaskResponse
	(*LookupTaskRequest)(nil),  // 6: timecraft.server.v1.LookupTaskRequest
	(*LookupTaskResponse)(nil), // 7: timecraft.server.v1.LookupTaskResponse
	(*VersionRequest)(nil),     // 8: timecraft.server.v1.VersionRequest
	(*VersionResponse)(nil),    // 9: timecraft.server.v1.VersionResponse
}
var file_timecraft_server_v1_timecraft_proto_depIdxs = []int32{
	3, // 0: timecraft.server.v1.HTTPRequest.headers:type_name -> timecraft.server.v1.Header
	1, // 1: timecraft.server.v1.SubmitTaskRequest.module:type_name -> timecraft.server.v1.ModuleSpec
	2, // 2: timecraft.server.v1.SubmitTaskRequest.request:type_name -> timecraft.server.v1.HTTPRequest
	0, // 3: timecraft.server.v1.LookupTaskResponse.state:type_name -> timecraft.server.v1.TaskState
	4, // 4: timecraft.server.v1.TimecraftService.SubmitTask:input_type -> timecraft.server.v1.SubmitTaskRequest
	6, // 5: timecraft.server.v1.TimecraftService.LookupTask:input_type -> timecraft.server.v1.LookupTaskRequest
	8, // 6: timecraft.server.v1.TimecraftService.Version:input_type -> timecraft.server.v1.VersionRequest
	5, // 7: timecraft.server.v1.TimecraftService.SubmitTask:output_type -> timecraft.server.v1.SubmitTaskResponse
	7, // 8: timecraft.server.v1.TimecraftService.LookupTask:output_type -> timecraft.server.v1.LookupTaskResponse
	9, // 9: timecraft.server.v1.TimecraftService.Version:output_type -> timecraft.server.v1.VersionResponse
