"""
Unix socket backend for requests.

From https://github.com/mupuf/requests-unixsocket/blob/master/requests_unixsocket/adapters.py

See https://github.com/mupuf/requests-unixsocket/blob/master/LICENSE
"""
import socket
