...
func (rcv *File) RecordBatchOffsets(obj *RecordBatchLocation, j int) bool {
...
func (rcv *File) RecordBatchOffsetsLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(8))
	if o != 0 {
		return rcv._tab.VectorLen(o)
	}
...
func FileAddRecordBatchOffsets(builder *flatbuffers.Builder, recordBatchOffsets flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(2, flatbuffers.UOffsetT(recordBatchOffsets), 0)
}
func FileStartRecordBatchOffsetsVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
...
type RecordBatchLocation struct {
	_tab flatbuffers.Struct
}

func (rcv *RecordBatchLocation) Init(buf []byte, i flatbuffers.UOffsetT) {
	rcv._tab.Bytes = buf
	rcv._tab.Pos = i
}

func (rcv *RecordBatchLocation) Table() flatbuffers.Table {
	return rcv._tab.Table
}

func (rcv *RecordBatchLocation) StartOffset() int64 {
	return rcv._tab.GetInt64(rcv._tab.Pos + flatbuffers.UOffsetT(0))
}
func (rcv *RecordBatchLocation) MutateStartOffset(n int64) bool {
	return rcv._tab.MutateInt64(rcv._tab.Pos+flatbuffers.UOffsetT(0), n)
}

func (rcv *RecordBatchLocation) FileOffset() int64 {
	return rcv._tab.GetInt64(rcv._tab.Pos + flatbuffers.UOffsetT(8))
}
func (rcv *RecordBatchLocation) MutateFileOffset(n int64) bool {
	return rcv._tab.MutateInt64(rcv._tab.Pos+flatbuffers.UOffsetT(8), n)
}

func CreateRecordBatchLocation(builder *flatbuffers.Builder, startOffset int64, fileOffset int64) flatbuffers.UOffsetT {
	builder.Prep(8, 16)
	builder.PrependInt64(fileOffset)
	builder.PrependInt64(startOffset)
